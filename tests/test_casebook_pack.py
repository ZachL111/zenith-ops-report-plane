"""Regression checks for the zenith-ops-report-plane casebook."""
...
from casebook.harness import assert_expected, zenith_ops_report_plane_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(zenith_ops_report_plane_summary(), assert_expected())
